...
window.SECTION_DEFS = [
  ...
  { id:"identity", title:"Identity Documents", short:"Identity", reg:"AR 601-210 · Ch.2", cond:A, items:[
    ...
    { id:"passport", cond:A,   init:"pending",  label:"U.S. Passport",
      sub:"If applicable — N/A if not available; mark N/A and note in remarks",
      help:h("U.S. Passport","AR 601-210 para 2-3","Required if the applicant has one. Verify name, DOB, and citizenship status match all other documents. Passport does not need to be current to satisfy the ID requirement, but note if expired. For LPR/naturalized applicants, a foreign passport may also be present — verify it is not being used to establish citizenship status.",null,null) },
    ...
    { id:"fp-lpr",   cond:LPR, init:"pending",  label:"Foreign Passport",
      sub:"LPR applicants — required if available",
